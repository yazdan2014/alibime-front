          ...
          <div class="step-header">
            ...
            <ul class="step-pills">
              <li class="step-item d-flex">
                ...
                <div v-if="storeState.getBrandName" class="step-link">
                  <span class="tabStatus">برند: </span>
                  <span class="tabLabel">{{ storeState.getBrandName }}</span>
                </div>
                <div v-if="storeState.getModelName" class="step-link">
                  <span class="tabStatus">مدل: </span>
                  <span class="tabLabel">{{ storeState.getModelName }}</span>
                </div>
                <div v-if="storeState.getCarbuildyear" class="step-link">
                  <span class="tabStatus">سال‌ساخت: </span>
                  <span class="tabLabel">{{ storeState.getCarbuildyear }}</span>
                </div>
                <div v-if="storeState.getPreviousCompanyName" class="step-link">
