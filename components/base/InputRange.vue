    ...
    <div id="form-wrapper">
      <form method="GET">
        <div id="debt-amount-slider">
          ...
          <label for="6" data-debt-amount="$10k-25k"></label>
          <input type="radio" name="debt-amount" id="7" value="7" required />
          <label for="7" data-debt-amount="$25k-50k"></label>
          <input type="radio" name="debt-amount" id="8" value="8" required />
          <label for="8" data-debt-amount="$50k-100k"></label>
          <input type="radio" name="debt-amount" id="9" value="9" required />
          <label for="9" data-debt-amount="$100k+"></label>
