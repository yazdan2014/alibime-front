        ...
        <div class="ins-step-box">
          <div class="step-header">
            <div class="wizard-header">
              <h3 class="wizard-title">استعلام و خرید بیمه آتش‌سوزی</h3>
            ...
            <ul class="step-pills">
              <li class="step-item d-flex">
                ...
                <div v-if="storeState.BuildingType" class="step-link">
                  <span class="tabStatus">نوع ساختمان: </span>
                  <span class="tabLabel">{{ storeState.BuildingType }}</span>
                </div>
                <div v-if="storeState.buildingStructureType" class="step-link">
                  <span class="tabStatus">نوع سازه: </span>
                  <span class="tabLabel">{{
                    storeState.buildingStructureType
                  }}</span>
                </div>
                <div v-if="storeState.buildingProductionYear" class="step-link">
                  <span class="tabStatus">سال ساخت: </span>
                  <span class="tabLabel">{{
                    storeState.buildingProductionYear
                  }}</span>
                </div>
                <div v-if="storeState.buildingMeter" class="step-link">
                  <span class="tabStatus">متراژ: </span>
                  <span class="tabLabel">{{ storeState.buildingMeter }}</span>
                </div>
