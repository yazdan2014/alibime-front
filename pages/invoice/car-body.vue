            ...
            <div class="invoice_page">
              <div class="invoce_sec">
                <h4 class="invoice_title">
                  مشخصات خرید <b-icon icon="Cart-check-fill"></b-icon>
                </h4>

                <div class="invoice_items">
                  <div class="items">
                    <div class="name">شرکت بیمه</div>
                    <div class="name_">آسیا</div>
                  </div>
                  <div class="items">
                  ...
                  <div class="items">
                    <div class="name">اصالت خودرو</div>
                    <div class="name_">{{ carisIrani }}</div>
                  </div>
                  <div class="items">
                  ...
                  <div class="items">
                    <div class="name">شرکت بیمه گر بیمه ثالث</div>
                    <div class="name_">{{ thirdPartyCompany }}</div>
                  </div>
                  <div class="items">
                    <div class="name">درصد تخفیف بیمه نامه ثالث</div>
                    <div class="name_">{{ thirdPartyDiscount }}</div>
                  </div>
                  <div class="items">
                    <div class="name">تخفیف بیمه قبلی</div>
                    <div class="name_">{{ carBodyDiscount }}</div>
                  </div>
                  <div class="items">
                    <div class="name">پوششهای اضافی</div>
                    <div class="name_">
                      <span v-if="coverChemical">{{ coverchemical_ }} ,</span>
                      <span v-if="coverGlassBreak"
                        >{{ coverglassbreak_ }} ,</span
                      >
                      <span v-if="coverNaturalDisasters"
                        >{{ covernaturaldisasters_ }} ,</span
                      >
                      <span v-if="coverTheftOfParts"
              ...
              <div class="invoce_sec">
                <h4 class="invoice_title">
                  جزئیات پرداخت <b-icon icon="Wallet-fill"></b-icon>
                </h4>
                ...
                <div class="gateway_select">
                  ...
                  <div class="gateways p-4">
                    <div class="gateway_brand text-center">
                      <b-form-radio v-model="gateway_selected" value="idpay">
                        <img
                          ...
                          src="\resource\img\gateways\idpay.svg"
                          alt="درگاه آی دی پی"
                        />
                      </b-form-radio>
                    </div>
                    <div class="policy">
                      <h4>
                        با زدن دکمه "تایید و پرداخت"، شرایط و قوانین را مطالعه
                        نموده و پذیرفته ام.
                      </h4>
                    </div>
                    <div class="payment_btn">
                      <div
                        class="pay_btn step-button"
...
export default {
  ...
  data() {
    return {
      ...
      carBodyDiscount: null,
      coverChemical: null,
      coverGlassBreak: null,
      coverNaturalDisasters: null,
      coverPriceFluctuation: null,
      coverTheftOfParts: null,
      coverTransportation: null,
  ...
  methods: {
    ...
    getData(id) {
      this.$store.dispatch('orders/getOrderbyID', id).then((result) => {
        ...
        this.carisIrani = result.carisIrani
        this.carBuildYear = result.carBuildYear
        this.carValue = parseInt(result.carValue)
        this.thirdPartyCompany = result.thirdPartyCompany
        this.thirdPartyDiscount = result.thirdPartyDiscount
        this.carBodyDiscount = result.carBodyDiscount
        this.coverChemical = result.coverChemical
        this.coverGlassBreak = result.coverGlassBreak
        this.coverNaturalDisasters = result.coverNaturalDisasters
        this.coverPriceFluctuation = result.coverPriceFluctuation
        this.coverTheftOfParts = result.coverTheftOfParts
        this.coverTransportation = result.coverTransportation
